...
MissileBullet::MissileBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret* parent, int damage) :
	Bullet("play/bullet-3.png", 100, damage, position, forwardDirection, rotation + ALLEGRO_PI / 2, parent) {
}
