...
Enemy::Enemy(std::string img, float x, float y, float radius, float speed, float hp, int money, int exp) :
	Engine::Sprite(img, x, y), speed(speed), hp(hp), money(money) , exp(exp){
