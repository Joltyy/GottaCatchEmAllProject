...
void Slider::Draw() const {
    // TODO: done [HACKATHON-3-BUG] (4/5): Draw the nested components here, so they are displayed correctly 
	Bar.Draw();
	End1.Draw();
	End2.Draw();
	ImageButton::Draw();
...
void Slider::SetValue(float value) {
	if (this->value != value) {
        // TODO: done [HACKATHON-3-BUG] (5/5): Fix the function, so it can set the slider value correctly 
		//this->value = value;
